...
| `FontSize` | 30 | 主歌词字号 |
| `TransFontSize` / `NextFontSize` | 20 / 17 | 翻译 / 下一句字号 |
| `FollowMain` | true | 次级字号是否跟随主歌词比例 |
| `TransRatio` / `NextRatio` | 0.66 / 0.56 | 跟随比例 |
